...
function CountdownTimer({ targetDate }) {
  ...
  const timerComponents = Object.keys(timeLeft).map((interval) => (
    <div className="timer-segment" key={interval}>
      <span className="timer-value">{timeLeft[interval] || 0}</span>
  ...
  return (
    <div className="app">
      <header className="navbar">
        <h1 className="title">HackoSphere</h1>
        <nav>
      ...
      <main className="main-content">
        <div className="content-left">
          <h2 className="floating-heading">Discover Hackathon Topics</h2>
          <div className="decorative-box-container">
            <div className="decorative-box1"></div>
            <div className="decorative-box2"></div>
            <div className="decorative-box3"></div>
          </div><b></b>
          <p className="floating-paragraph"><b></b>Hackathons are a great way to solve real-world problems through collaboration.
            Explore innovative topics and showcase your creativity with impactful solutions.
            Join us to innovate, collaborate, and create solutions that make a difference.
            Dive into challenges, learn from peers, work in a team, and emerge as a problem-solver!
          </p>
        </div>
    ...
    <div className="app-container">
      ...
      <nav className="navbar">
        <div className="container">
          <h1 className="logo">HackoSphere</h1>
          <ul className="nav-links">
            <li><a href="#home">Home</a></li>
            <li><a href="#agenda">Agenda</a></li>
            <li><a href="#faq">FAQ</a></li>
      ...
      <section id="home" className="hero">
        ...
        <p className="hero-subtitle">
          Explore hackathons happening worldwide and unlock endless opportunities.
        </p>
      ...
      <section id="agenda" className="agenda">
        ...
        <ul className="agenda-list">
          <li>Introduction and Networking</li>
          <li>Problem Statement Release</li>
          <li>Coding Marathon</li>
          <li>Workshops and Mentoring</li>
          <li>Project Demos</li>
      ...
      <section id="faq" className="faq">
        ...
        <div className="faq-item">
          ...
          <p>A hackathon is an event where participants solve problems through coding and collaboration.</p>
        </div>
        <div className="faq-item">
          <h3>Who can participate?</h3>
          <p>Students, professionals, and anyone interested in coding can join.</p>
        </div>
        <div className="faq-item">
          <h3>Are there any prizes?</h3>
          <p>Yes, we offer exciting prizes for winners and participants.</p>
        </div>
      </section>

     
      <section id="about" className="about">
        <h2 className="section-title">About HackoSphere</h2>
        <p className="about-text">
          HackoSphere is a platform that connects aspiring coders to hackathons worldwide. We aim to foster innovation, creativity, and collaboration among participants.
        </p>
      </section>

   
      <footer className="footer">
        <p>&copy; 2025 HackoSphere. All rights reserved.</p>
      </footer>
    </div>
  );
};
